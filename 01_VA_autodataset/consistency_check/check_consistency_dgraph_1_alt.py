...
compare_two("dgrap_req_1_rez.txt","dgrap_req_1_alt_rez.txt",  "reservation-\d+")
compare_two("atomspace_reqs_1_rez.txt","dgrap_req_1_alt_rez.txt",  "reservation-\d+")
