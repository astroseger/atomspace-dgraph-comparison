...
def print_reserv(reserv_id):
    ...
    out_atomspace.write('(EvaluationLink (PredicateNode "Reservation") (ListLink (ConceptNode "%s") (ConceptNode "%s")))\n'% (reserv, rest))
    for pid in pids:
        out_atomspace.write('(EvaluationLink (PredicateNode "Participant") (ListLink (ConceptNode "%s") (ConceptNode "%s")))\n'%(reserv, name_person(pid)))
